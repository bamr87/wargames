...
description: 'Reading material
  ...
  ================'
permalink: /docs/wargames/blacksun/reading_material/
...
source_url: https://github.com/OverTheWireOrg/OverTheWire-website/blob/gh-pages/blacksun/reading_material.md
