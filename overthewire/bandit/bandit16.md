...
description: 'Level Goal
  ...
  SSL/TLS encryption.'
permalink: /docs/wargames/bandit/bandit16/
...
source_url: https://github.com/OverTheWireOrg/OverTheWire-website/blob/gh-pages/bandit/bandit16.md
source_name: overthewire
license: MIT
author: bamr87
excerpt: OverTheWire Bandit level 16 — practice Linux command-line and security skills through hands-on challenges.
draft: false
keywords:
- security
- wargames
