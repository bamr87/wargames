...
description: 'Level Goal
  ...
  inhere directory.'
permalink: /docs/wargames/bandit/bandit4/
...
source_url: https://github.com/OverTheWireOrg/OverTheWire-website/blob/gh-pages/bandit/bandit4.md
source_name: overthewire
license: MIT
author: bamr87
excerpt: OverTheWire Bandit level 4 — practice Linux command-line and security skills through hands-on challenges.
draft: false
keywords:
- security
- wargames
